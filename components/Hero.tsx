...
const Hero: FC<THeroProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center ">
      <a
        className="mb-4 inline-flex h-7 shrink-0 items-center gap-[9px] rounded-[10px] border-[0.5px] border-solid border-1.2  border-[#1B1B16] bg-white px-3 py-4 shadow-[0px_1px_1px_0px_rgba(0,0,0,0.25)]"
      ...
      <div className="flex flex-wrap items-center justify-center gap-2.5 pb-[30px] lg:flex-nowrap  lg:justify-normal">
        {suggestions.map((item) => (
          <div
            className="flex h-[35px] bg-purple border-1 border-bgblack  cursor-pointer items-center justify-center gap-[5px] rounded border border-solid border-[#C1C1C1] bg-[#EDEDEA] px-2.5 py-2"
          ...
          >
            <Image
              ...
              className="w-[18px]  "
            />
            <span className="text-sm font-light leading-[normal] text-fadewhite">
              {item.name}
            </span>
          </div>
        ))}
      ...
      <p className="text-center text-sm font-light leading-[normal] text-[#1B1B16]">
        ...
        <span className="text-sm font-medium underline">
          <a
            href="https://github.com/sanyogsr/"
            target="_blank"
